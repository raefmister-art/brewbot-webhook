...
function processMessage(text, session) {
  ...
  if (lowerText.includes('hi') || lowerText.includes('hello') || lowerText.includes('hey') || lowerText === 'help') {
    return "Hello! Great to chat with you!\n\nWhat can I help you with?\n\n🍳 Type 'order' - Place a food/drink order\n📋 Type 'menu' - See our food\n☕ Type 'coffee' - Order drinks  \n🎂 Type 'cake' - Order celebration cake\n🛒 Type 'cart' - Check your current order\n⏰ Type 'hours' - Opening times\n📍 Type 'location' - Find us\n❓ Ask about vegan, gluten-free, student discount\n\nJust tell me what you need!";
  }
